...
class VerifyEmailView(APIView):
    ...
    def get(self, request, uidb64, token):
        ...
        if default_token_generator.check_token(user, token):
            user.is_active = True
            user.save()
        url = "https://api.yummyyagi.com/user/login.html"
        return redirect(url)
...
KAKAO_BASE_URL = "https://api.yummyyagi.com/user/register.html"
GOOGLE_BASE_URL = "https://api.yummyyagi.com/user/register.html"
NAVER_BASE_URL = "https://api.yummyyagi.com/user/register.html"
