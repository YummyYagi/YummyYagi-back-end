...
class Story(models.Model):
    ...
    like = models.ManyToManyField(
        ...
        verbose_name="좋아요",
        related_name="like_stories",
        blank=True,
    )
    like_count = models.PositiveIntegerField("좋아요 개수", default=0)
    hate = models.ManyToManyField(
        settings.AUTH_USER_MODEL,
        verbose_name="싫어요",
        related_name="hate_stories",
        blank=True,
    )
...
class Content(models.Model):
    ...
    story = models.ForeignKey(
        Story, verbose_name="스토리", on_delete=models.CASCADE, related_name="contents"
    )
