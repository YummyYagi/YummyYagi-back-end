...
urlpatterns = [
    ...
    path(
        "like_sorted/",
        views.StorySortedByLikeView.as_view(),
        name="story_sorted_like_view",
    ),
    path(
        "country_sorted/<str:author_country>/",
        views.StorySortedByCountryView.as_view(),
        name="story_sorted_country_view",
    ),
    ...
    path(
        "<int:story_id>/bookmark/", views.BookmarkView.as_view(), name="bookmark_view"
    ),
    path("<int:story_id>/comment/", views.CommentView.as_view(), name="comment_view"),
    path(
        "<int:story_id>/comment/<int:comment_id>/",
        views.CommentView.as_view(),
        name="comment_delete_view",
    ),
    path(
        "fairytail_gpt/",
        views.RequestFairytail.as_view(),
        name="request_fairytail_view",
    ),
